...
public class T014PutRequest extends TestRun {
    ...
    public static void setUp() throws ClassNotFoundException, IOException, InterruptedException, JSONException {
        ...
        usernameOkStatus = "Dev24UserOK" + (new Date()).getTime();
        passwordOkStatus = "abc";
        usernameKoStatus = "Dev24UserKO" + (new Date()).getTime();
    ...
    public void checkPutIsSent() throws JSONException, ClassNotFoundException, NoSuchMethodException {
        ...
        Espresso.closeSoftKeyboard();
        Espresso.onView(withText("Loguearse")).perform(click());
        ...
        Espresso.onView(editTextWithHint("Hey! I've modified my status")).perform(typeText(newStatus));
        Espresso.closeSoftKeyboard();
        Espresso.onView(buttonWithText("Actualizar")).perform(click());
        // Assert
