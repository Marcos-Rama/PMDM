...
public class T012ButtonThatFloats {
    ...
    public void checkButtonIsPresentAndShowsEmptyDialog() throws ClassNotFoundException, NoSuchFieldException {
        cls.getDeclaredField("buttonChangeStatus");
        Espresso.onView(buttonWithText("Actualizar")).check(doesNotExist());
        ...
        Espresso.onView(buttonWithText("Actualizar")).check(matches(isDisplayed()));
    }
