...
public class T002AnotherEditText {
    ...
    public void checkEditTextPasswordIsCorrect() {
        ...
        Espresso.onView(editTextWithHint("Contraseña")).check(isLeftAlignedWith(editTextWithHint("jane.doe")));
        Espresso.onView(editTextWithHint("Contraseña")).check(isRightAlignedWith(editTextWithHint("jane.doe")));
        Espresso.onView(editTextWithHint("Contraseña")).check(isTopToBottomOf(editTextWithHint("jane.doe")));
        ...
        Espresso.onView(editTextWithHint("jane.doe")).check(hasDeclaredId());
    }
