...
public class ClipsAdapter extends RecyclerView.Adapter<ClipViewHolder> {
    ...
    @NonNull
    @Override
    public ClipViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {//COMO SON las celdas
    ...
    @Override
    public void onBindViewHolder(@NonNull ClipViewHolder holder, int position) {//QUE contenido hay en cada celda
    ...
    @Override
    public int getItemCount() { //CUANTAS celdas
