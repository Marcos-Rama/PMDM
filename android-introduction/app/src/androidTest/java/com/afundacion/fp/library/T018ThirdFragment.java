...
public class T018ThirdFragment {
    ...
    public void checkCorrectImageShownAfterClick() {
        ...
        Matcher<View> contentDescription = withContentDescription("Un Digimon excelente");
    ...
    public void checkCorrectImageShownAfterClickAndNotOther() {
        ...
        Matcher<View> contentDescription2 = withContentDescription("Un Digimon excelente");
