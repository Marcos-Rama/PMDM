...
public class T008OnClick {
    ...
    public void checkToastIsShownOnClick() throws ClassNotFoundException {
        Class handler = Class.forName("com.afundacion.fp.library.ActionHandler");
        Matcher<View> button = withText("Enseñar tostada");
        Matcher<View> toast = withText("¡Cuidado, que quema!");
